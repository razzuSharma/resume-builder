  ...
  return (
    <div className="p-8 max-w-4xl mx-auto bg-white rounded-xl shadow-lg">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-ce">Personal Details</h2>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc ml-5">
            ...
            <li>Collaborated with cross-functional teams to define project requirements and deliver solutions.</li>
        ...
        <div>
          ...
          <ul className="list-disc ml-5">
            <li>Assisted in the development of internal tools and client projects.</li>
            <li>Conducted code reviews and provided feedback to team members.</li>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          ...
          <p>Link: <a href="#" className="text-teal-500 hover:underline">Project Link</a></p>
